...
Step 4: To deploy application to gcloud platform:
      ...
      c. Type `docker buildx build --platform linux/amd64 --load -t gcr.io/flaskhelloworldapp-457910/flaskhelloworldapp .` or `docker build .` on cmd to build a docker image
      ...
      e. Now we can see newest created image has tag as <none> and its image id.
         ...
         docker tag 8463a216db01 gcr.io/flaskhelloworldapp-457910/flaskhelloworldapp
